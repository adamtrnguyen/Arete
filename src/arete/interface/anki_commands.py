...
@anki_app.command("cards-suspend", deprecated=True, hidden=True)
def _deprecated_cards_suspend(
    ctx: typer.Context,
    cids: Annotated[str, typer.Option(help="Comma-separated list of Card IDs (or JSON list).")],
    backend: Annotated[str | None, typer.Option(help="Force backend")] = None,
    anki_connect_url: Annotated[str | None, typer.Option(help="AnkiConnect URL Override")] = None,
    ...
    """(Deprecated) Use 'arete anki suspend' instead."""
    suspend_cards(
        ctx, cids=cids, backend=backend,
        anki_connect_url=anki_connect_url, anki_base=anki_base,
    )


@anki_app.command("cards-unsuspend", deprecated=True, hidden=True)
def _deprecated_cards_unsuspend(
    ctx: typer.Context,
    cids: Annotated[str, typer.Option(help="Comma-separated list of Card IDs.")],
    backend: Annotated[str | None, typer.Option(help="Force backend")] = None,
    anki_connect_url: Annotated[str | None, typer.Option(help="AnkiConnect URL Override")] = None,
    ...
    """(Deprecated) Use 'arete anki unsuspend' instead."""
    unsuspend_cards(
        ctx, cids=cids, backend=backend,
        anki_connect_url=anki_connect_url, anki_base=anki_base,
    )
...
@anki_app.command("models-styling", deprecated=True, hidden=True)
def _deprecated_models_styling(
    ctx: typer.Context,
    model: str = typer.Argument(..., help="Model Name"),
    backend: Annotated[str | None, typer.Option(help="Force backend")] = None,
    anki_connect_url: Annotated[str | None, typer.Option(help="AnkiConnect URL Override")] = None,
    ...
    """(Deprecated) Use 'arete anki model-css' instead."""
    model_css(
        ctx, model=model, backend=backend,
        anki_connect_url=anki_connect_url, anki_base=anki_base,
    )


@anki_app.command("models-templates", deprecated=True, hidden=True)
def _deprecated_models_templates(
    ctx: typer.Context,
    model: str = typer.Argument(..., help="Model Name"),
    backend: Annotated[str | None, typer.Option(help="Force backend")] = None,
    anki_connect_url: Annotated[str | None, typer.Option(help="AnkiConnect URL Override")] = None,
    ...
    """(Deprecated) Use 'arete anki model-templates' instead."""
    model_templates(
        ctx, model=model, backend=backend,
        anki_connect_url=anki_connect_url, anki_base=anki_base,
    )
